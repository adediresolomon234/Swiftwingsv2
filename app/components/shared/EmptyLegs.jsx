...
const EmptyLegsSlider = () => {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-0 text-gray-500">
      ...
      <div className="grid gap-4 md:mx-auto sm:grid-cols-2 lg:w-full xl:grid-cols-4 mx-auto my-auto">
        {visibleLegs.map((leg, index) => (
          <div
            key={index}
            className="max-w-sm bg-white border border-gray-200 group space-y-6 rounded-3xl text-center transition-all duration-300"
          >
