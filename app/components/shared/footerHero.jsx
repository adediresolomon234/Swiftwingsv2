...
const FooterHero = () => {
  return (
    <div className="mx-auto bg-floralwhite overflow-hidden mt-8 -mb-40">
      <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-8 lg:gap-96 relative mb-20">
        <div className="relative font-semibold inline-block shrink-0 w-full z-[2]">
          ...
          <img
            className="w-full mx-auto z-[3] transform lg:translate-x-[30px]"
            alt=""
        ...
        <div className="relative flex justify-center items-center w-full z-[1]">
          <img
            className="w-full max-h-[500px] right-0 object-contain"
            loading="lazy"
            alt=""
