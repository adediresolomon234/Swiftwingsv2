...
const CountryCard = ({ country }) => {
  ...
  return (
    <div className="w-full overflow-hidden flex flex-col sm:flex-row sm:gap-16 mb-10">
      <div className="relative w-full sm:w-2/5 h-fit">
        <img
          src={country.image}
          alt={country.name}
      ...
      <div className="w-full sm:w-3/5">
        <div className="flex flex-col items-start justify-start relative p-4">
          ...
          <div className="swGray500 flex-grow text-[16px]">
            {country.description}
          </div>
