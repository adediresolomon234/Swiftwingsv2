    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 h-11 px-3 py-2 border border-swGray300 rounded-lg hover:border-swPrimary500 focus:border-swPrimary500 focus:outline-none text-base font-normal text-gray-500"
        />
        <button
          type="button"
          onClick={addGuest}
