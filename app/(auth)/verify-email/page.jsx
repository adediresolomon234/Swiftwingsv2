          ...
          <div className="max-w-md p-4 overflow-x-hidden">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Next step: Enter the 6-digit verification code we sent to your
                email address.
              </p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
              <p className="text-sm text-blue-800">
                <strong>Next step:</strong> Enter the 6-digit verification code
                sent to your email. After verification, you&apos;ll be
                redirected to the login page to access your account.
              </p>
            </div>
            ...
            <div className="my-7 flex flex-col gap-3">
              <Button
                ...
                bgColor={
                  "bg-swPrimary500 hover:bg-swPrimary600 text-white w-full"
                }
            ...
            <div className="text-center">
              ...
              <Button
                ...
                textColor={
                  "font-semibold text-swPrimary500 border border-swPrimary500 max-w-lg hover:bg-swPrimary50"
                }
            ...
            <div className="w-full flex justify-center mt-6 font-medium">
              <Button
                ...
                textColor={
                  "font-semibold text-swGray800 border border-swGray100 max-w-lg hover:bg-gray-50"
                }
                onClick={() => {
                  router.push("/sign-in");
                }}
