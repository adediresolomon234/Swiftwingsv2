          ...
          <div className="relative mx-auto max-w-screen-full px-4 py-28 sm:px-6 lg:flex lg:h-[70vh]  lg:items-center lg:px-8">
            <div className="max-w-xl mx-auto text-center">
              ...
              <p className="text-md">
                ...
                Jets contact channels
              </p>
            </div>
          </div>
        </div>
        <section className="py-16">
          <div className="m-auto px-6 text-gray-600 md:px-12 xl:px-16"></div>
        </section>
        <section className="py-16">
                ...
                <div class="group p-6 sm:p-8 rounded-3xl bg-white ">
                  <div class="mt-6 relative">
                    ...
                    <p class="mt-6 mb-8 text-gray-600 dark:text-gray-300">
                      ...
                      offers extensive global coverage to meet the travel needs
                      of our clients, seamlessly connecting them to destinations
                      worldwide, including Europe, North America, South America,
                      and beyond. With a network of trusted partners and
                      affiliates, we ensure convenience and flexibility in air
                      travel on a global scale, even to the most remote corners
                      of the world.
                    </p>
                  </div>
                </div>
