          ...
          <div className="m-auto px-6 text-gray-600 md:px-12 xl:px-16">
            <div className="max-w-3xl mx-auto text-md lg:text-center">
              <h1 className="text-md md:text-lg text-swGray900">
                ...
                delivery of top-notch service are the cornerstones of everything
                we do at Swift Wings. Our dedication lies in not just meeting
                but exceeding our clients expectations by constantly exploring
                new horizons and pushing the limits.
              </h1>
            </div>
          </div>
        </section>
          ...
          <div className="m-auto px-2 text-gray-600 md:px-12 xl:px-16">
            <div className="max-w-5xl mx-auto text-justify lg:text-center">
              <ul className="p-2 mb-3 flex flex-col sm:flex-row overflow-x-auto no-scrollbar">
                ...
                >
                  To be the leading private jet charter company in the industry,
          ...
          <div className="w-full relative h-[1033px] text-left text-5xl text-gray-900 font-body-md-regular hidden sm:block">
            ...
            <div className="absolute top-[66px] left-[calc(50%_-_684px)] w-[634px] flex flex-col items-start justify-start gap-[26px]">
              ...
              <div className="text-sm">
                Recognising that our team of aviation professionals is our most
                valuable asset, Swift Wings has meticulously assembled a group
                of highly experienced and dedicated individuals who share a
                passion for delivering unmatched service. Each team member is
                committed to ensuring that every aspect of your journey is safe,
                comfortable, speedy, and hassle-free.
              </div>
            </div>
            <div className="relative text-left text-5xl text-gray-900 font-body-md-regular">
              <div className="absolute top-[825px] left-[calc(50%_-_138px)] w-[634px] flex flex-col items-start justify-start gap-[26px]">
                ...
                <div className="text-sm">
                  ...
                  destination, our team of dedicated professionals is committed
                  to delivering unparalleled service that caters to your every
                  need.
                </div>
              </div>
              <Image
              ...
              <div className="">
                ...
                <div className="text-lg text-gray-800 p-6">
                  ...
                  <p className="text-md lg:text-lg text-swGray800">
                    Safety is the cornerstone of our operations. At SwiftWings,
                    we prioritize the safety and well-being of our passengers
                    above all else. With rigorous safety standards and
                    meticulous attention to detail, we ensure every journey with
                    us is secure and stress-free.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="bg-swGray50 lg:p-16 rounded-[4rem] space-y-6 md:flex md:gap-6 justify-center md:space-y-0 lg:items-center">
                ...
                <div class="md:7/12 lg:w-4/5">
                  <p class="my-8 text-swGray800">
                    Choosing SwiftWings means choosing quality, reliability, and
                    unparalleled luxury. With our commitment to excellence,
                    passion for innovation, and customer-centric approach, we
                    offer a level of service that goes above and beyond your
                    expectations.
                  </p>
                </div>
              </div>
              ...
              <div className="group p-6 sm:p-8 rounded-3xl bg-white ">
                <div className="mt-6 relative">
                  ...
                  <p className="mt-6 mb-8 text-swGray800">
                    ...
                    industry. Our aviation experts are dedicated to customizing
                    every aspect of your journey to align with your preferences
                    and needs, ensuring a truly unforgettable experience.
                  </p>
                </div>
              </div>
              <div className="group p-6 sm:p-8 rounded-3xl bg-white  ">
                <div className="mt-6 relative">
                  ...
                  <p className="mt-6 mb-8 text-swGray800">
                    ...
                    travel with our diverse fleet, accommodating various budgets
                    and travel needs. Whether it is a short trip on a light jet
                    or a long-haul journey on a spacious cabin jet, our advanced
                    aircraft, such as the Hawker 850xp and Bombardier Challenger
                    604, ensure unparalleled comfort, luxury, and reliability
                    for every passenger.
                  </p>
                </div>
              </div>
