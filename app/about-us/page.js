  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Swift Wings was founded in June 2017 with a mission to offer extraordinary aviation services to individuals with a keen eye for quality, as well as to esteemed corporate leaders and organisations throughout Nigeria. Safety and delivering top-notch service are the cornerstones of everything we do at Swift Wings."
        />
        <meta name="keywords" content={aboutUsPageKeywords} />
      </Head>
            ...
            <div className="m-auto px-6 text-gray-600 md:px-12 xl:px-16">
              <div className="max-w-3xl mx-auto text-md lg:text-center">
                <h1 className="text-md md:text-lg text-swGray900">
                  Swift Wings was founded in June 2017 with a mission to provide
                  extraordinary aviation services to individuals with a keen eye
                  for quality, as well as to esteemed corporate leaders and
                  organisations throughout Nigeria. Speed, luxury, safety and
                  delivery of top-notch service are the cornerstones of
                  everything we do at Swift Wings. Our dedication lies in not
                  just meeting but exceeding our clients expectations by
                  constantly exploring new horizons and pushing the limits.
                </h1>
              </div>
            </div>
          </section>
            ...
            <div className="m-auto px-2 text-gray-600 md:px-12 xl:px-16">
              <div className="max-w-5xl mx-auto text-justify lg:text-center">
                <ul className="p-2 mb-3 flex flex-col sm:flex-row overflow-x-auto no-scrollbar">
                  ...
                  <li
                    className="w-auto text-xl mx-1 p-3 sm: text-md lg:text-lg px-2 sm:w-auto sm:text-start "
                    style={{ fontFamily: "auto" }}
                  >
                    To be the leading private jet charter company in the
            ...
            <div className="m-auto px-2 text-gray-600 md:px-12 xl:px-16">
              <div className="max-w-5xl mx-auto text-justify lg:text-center">
                <ul className="p-2 mb-3 flex flex-col-reverse sm:flex-row overflow-x-auto no-scrollbar">
                  <li
                    className="text-xl w-auto mx-1 p-3 sm:text-lg lg:text-lg px-2  sm:w-auto sm:text-justify lg:text-end"
                    style={{ fontFamily: "auto" }}
                  >
                    We aim to provide seamless, personalised experiences that
                    exceed your expectations every time you fly with us. Our
                    mission is to ensure your journey is safe, comfortable, and
                    unforgettable, no matter where you&apos;re headed
                  </li>
          ...
          <section className="py-16">
            <div className="w-full relative h-[1033px] text-left text-5xl text-gray-900 font-body-md-regular hidden sm:block">
              ...
              <div className="absolute top-[66px] left-[calc(50%_-_684px)] w-[634px] flex flex-col items-start justify-start gap-[26px]">
                <p className="text-md">Safety First</p>
                <div className="text-sm">
                  Recognising that our team of aviation professionals is our
                  most valuable asset, Swift Wings has meticulously assembled a
                  group of highly experienced and dedicated individuals who
                  share a passion for delivering unmatched service. Each team
                  member is committed to ensuring that every aspect of your
                  journey is safe, comfortable, speedy, and hassle-free.
                </div>
              </div>
              <div className="relative text-left text-5xl text-gray-900 font-body-md-regular">
                <div className="absolute top-[825px] left-[calc(50%_-_138px)] w-[634px] flex flex-col items-start justify-start gap-[26px]">
                  <p className="text-md">Service Excellence</p>
                  <div className="text-sm">
                    Service excellence is ingrained in our DNA. From the moment
                    you book your flight to the second you touch down at your
                    destination, our team of dedicated professionals is
                    committed to delivering unparalleled service that caters to
                    your every need.
                  </div>
                </div>
                <Image
              ...
              <div className="sm:hidden">
                <div className="">
                  ...
                  <div className="text-lg text-gray-800 p-6">
                    ...
                    <p className="text-md lg:text-lg text-swGray800">
                      Safety is the cornerstone of our operations. At
                      SwiftWings, we prioritize the safety and well-being of our
                      passengers above all else. With rigorous safety standards
                      and meticulous attention to detail, we ensure every
                      journey with us is secure and stress-free.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="bg-swGray50 lg:p-16 rounded-[4rem] space-y-6 md:flex md:gap-6 justify-center md:space-y-0 lg:items-center">
                  ...
                  <div class="md:7/12 lg:w-4/5">
                    <p class="my-8 text-swGray800">
                      Choosing SwiftWings means choosing quality, reliability,
                      and unparalleled luxury. With our commitment to
                      excellence, passion for innovation, and customer-centric
                      approach, we offer a level of service that goes above and
              ...
              <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="group p-6 sm:p-8 rounded-3xl bg-white ">
                  <div class="mt-6 relative">
                    ...
                    <p class="mt-6 mb-8 text-swGray800">
                      Swift Wings offers extensive global coverage to meet the
                      travel needs of our clients, seamlessly connecting them to
                      destinations worldwide, including Europe, North America,
                      South America, and beyond. With a network of trusted
                      partners and affiliates, we ensure convenience and
                      flexibility in air travel on a global scale, even to the
                ...
                <div className="group p-6 sm:p-8 rounded-3xl bg-white ">
                  <div className="mt-6 relative">
                    ...
                    <p className="mt-6 mb-8 text-swGray800">
                      At Swift Wings, we ensure every journey is a remarkable
                      experience by maintaining a tailored fleet of private jets
                      that epitomize luxury, comfort, and convenience. From the
                      moment you step on board, you will experience an
                      unparalleled level of service that stands unrivaled in the
                      industry. Our aviation experts are dedicated to
                      customizing every aspect of your journey to align with
                      your preferences and needs, ensuring a truly unforgettable
                      experience.
                    </p>
                  </div>
                </div>
                <div className="group p-6 sm:p-8 rounded-3xl bg-white  ">
                  <div className="mt-6 relative">
                    ...
                    <p className="mt-6 mb-8 text-swGray800">
                      At Swift Wings, we prioritize accessibility in private jet
                      travel with our diverse fleet, accommodating various
                      budgets and travel needs. Whether it is a short trip on a
                      light jet or a long-haul journey on a spacious cabin jet,
                      our advanced aircraft, such as the Hawker 850xp and
                      Bombardier Challenger 604, ensure unparalleled comfort,
                      luxury, and reliability for every passenger.
                    </p>
                  </div>
                </div>
              </div>
