          ...
          <div className="m-auto px-6 text-gray-600 md:px-12 xl:px-16">
            <div className="max-w-3xl mx-auto text-justify lg:text-center">
              <h1 className="px-2 sm: text-md lg:text-lg ">
                ...
                , where the sky is not the limit – it is just the beginning.
                Since our establishment in June 2017, we have been dedicated to
                revolutionizing the aviation industry in Nigeria and beyond.
              </h1>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-5xl mx-auto text-justify lg:text-center">
              <ul className="p-2 mb-12 flex flex-col sm:flex-row overflow-x-auto no-scrollbar">
                ...
                <li className="w-auto mx-1 p-3 sm: text-md lg:text-lg px-2 border-gray-200 sm:w-auto sm:text-start ">
                  ...
                  , our mission is simple yet profound: to offer exceptional
                  aviation services that redefine luxury, reliability, and
                  safety. We aim to exceed the expectations of our clients by
                  providing unparalleled experiences with every flight.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="w-full relative h-[1033px] text-left text-5xl text-gray-900 font-body-md-regular hidden sm:block">
            ...
            <div className="absolute top-[66px] left-[calc(50%_-_684px)] w-[634px] flex flex-col items-start justify-start gap-[26px]">
              ...
              <div className="self-stretch relative text-xl leading-[30px] text-gray-800">
                ...
                above all else. With rigorous safety standards and meticulous
                attention to detail, we ensure every journey with us is secure
                and stress-free.
              </div>
            </div>
              ...
              <div class="lg:bg-gray-50 dark:lg:bg-darker lg:p-16 rounded-[4rem] space-y-6 md:flex md:gap-6 justify-center md:space-y-0 lg:items-center">
                ...
                <div class="md:7/12 lg:w-4/5">
                  <p class="my-8 text-gray-600 dark:text-gray-300">
                    ...
                    means choosing quality, reliability, and unparalleled
                    luxury. With our commitment to excellence, passion for
                    innovation, and customer-centric approach, we offer a level
                    of service that goes above and beyond your expectations.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="group p-6 sm:p-8 rounded-3xl bg-white ">
                  <div className="mt-6 relative">
                    ...
                    <p className="mt-6 mb-8 text-gray-600 dark:text-gray-300">
                      ...
                      , we ensure every journey is a remarkable experience by
                      maintaining a tailored fleet of private jets that
                      epitomize luxury, comfort, and convenience. From the
                ...
                <div className="group p-6 sm:p-8 rounded-3xl bg-white  ">
                  <div className="mt-6 relative">
                    ...
                    <p className="mt-6 mb-8 text-gray-600 dark:text-gray-300">
                      ...
                      , we prioritize accessibility in private jet travel with
                      our diverse fleet, accommodating various budgets and
                      travel needs. Whether it is a short trip on a light jet or
                      a long-haul journey on a spacious cabin jet, our advanced
                      aircraft, such as the Hawker 850xp and Bombardier
                      Challenger 604, ensure unparalleled comfort, luxury, and
                      reliability for every passenger.
                    </p>
                  </div>
                </div>
              </div>
