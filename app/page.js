      ...
      <NavAndFooter>
        ...
        <section className=" max-w-6xl mx-auto py-10">
          ...
          <div className="flex flex-col items-center gap-5 mt-14">
            ...
            <div className="bg-swSecondary500 text-swPrimary500 p-8 max-w-[44rem] rounded-2xl">
        ...
        <section className="max-w-6xl mx-auto py-10">
          <div className="relative pt-40 pb-20 lg:pt-44">
            <div className="relative 2xl:container m-auto px-6 md:px-12 lg:px-6">
              <p className="sm:mx-auto sm:w-10/12 md:w-2/3 text-swPrimary500 font-semibold text-center sm:text-[18px] md:text-[18px] lg:text-[18px] lg:w-auto lg:text-left">
                Fleet Showcase
              </p>
              <h1 className="mt-8 sm:mx-auto sm:w-10/12 md:w-2/3 text-swGray900 text-4xl font-semibold text-center sm:text-5xl md:text-6xl lg:w-auto lg:text-left xl:text-7xl">
                Our Fleet.
              </h1>
                    ...
                    >
                      <div className="grid grid-cols-1 gap-2 lg:grid-cols-3 lg:gap-2 mt-2 pb- p-6 border-gray-200 duration-300 hover:shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] rounded-lg">
                        ...
                        <div className="flex-1 flex flex-col items-start justify-between text-xs text-gray-800 px-3 py-1 lg:col-span-2">
                          ...
                          <div className=" self-stretch relative leading-[18px] mt-2 mx-2 text-swGray500">
                            {item.size}
                          </div>
                        </div>
                      </div>
        ...
        <section className="max-w-6xl mx-auto py-10">
          <div className="container mx-auto px-6 text-center md:px-12">
            <div className="mb-16">
              ...
              <p className="text-swGray900  font-semibold lg:w-8/12 mt-8 sm:mx-auto sm:w-10/12 md:w-2/3  text-4xl text-center sm:text-5xl md:text-6xl">
        ...
        <section className="max-w-6xl mx-auto py-10">
          <div className="container mx-auto px-6 text-center md:px-12">
            <div className="mb-16">
              <h2 className="mb-4 text-center text-[18px]  text-swPrimary500 dark:text-white md:text-[18px] ">
                    ...
                    <div className="relative h-96 w-[768px] p-12 flex flex-col justify-between items-start">
                      <div>
                        ...
                        <h2 className="text-gray-700 dark:text-gray-300 mt-8 sm:mx-auto text-xl text-start sm:text-xl md:text-xl">
                          Swift Wings Ltd offers an exclusive Jet Card
                          Membership, providing discerning travelers with
                          unparalleled access to private jet charter services.
                          As a Jet Card member, you enjoy priority booking and
                          seamless travel experiences tailored to your
                          preferences.
                        </h2>
                      </div>
                    </div>
