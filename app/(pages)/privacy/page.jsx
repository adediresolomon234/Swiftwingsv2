                ...
                <div className="mx-auto w-full lg:px-24 max-w-7xl md:px-12 items-center px-8 py-24">
                    ...
                    <div>
                        <div className="mx-auto max-w-[40rem] prose-base prose text-gray-500 prose-h3:text-black prose-a:font-semibold prose-a:text-accent-300 hover:prose-a:text-black">
                            ...
                            <h3 className="font-bold mb-8">Personal Information Collection</h3>
                            <p className="mb-8">
                            ...
                            <h3 className="font-bold mb-8">Personal Data from Third Parties</h3>
                            <p className="mb-8">
                            ...
                            <ul className="mb-8 leading-10">
                                <li>
                                    <strong>Access:</strong> You may request from us access to your data that we hold on
                                    you.
                                </li>
                                <li>
                                <strong> Rectification:</strong> If the data we hold on you is inaccurate, you may
                                    request that we correct it. If the data we hold is incomplete, you
                                    may request that we complete it.
                                </li>
                                <li>
                                <strong>Erasure:</strong> Subject to certain conditions, you may request that we
                                    erase all of the data we hold on you.
                                </li>
                                <li>
                                <strong>Restrictions:</strong> Subject to certain conditions, you may request that we restrict the processing of data we hold on you.
                                </li>
                                <li>
                                <strong>Portability:</strong> Subject to certain conditions, you may request that we
                                    transfer all the data we hold on you to a third party (including
                                    yourself).
                                </li>
                                <li>
                                <strong>Objections:</strong> Subject to certain conditions, you may object to us
                            ...
                            <h3 className="font-bold mb-8">Merger, acquisition or asset sale</h3>
                            <p className="mb-8">
