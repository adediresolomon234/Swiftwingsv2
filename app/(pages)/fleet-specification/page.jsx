...
const FleetSpec = () => {
  ...
  if (!id) {
    return <div>No aircraft ID provided.</div>;
  }
                      ...
                      <div className="ml-10">
                        <div className="grid grid-cols-3 gap-4 w-full max-w-full rounded-xl bg-white border border-gray-200 overflow-hidden">
                          <div className="flex flex-col items-center justify-center py-6 px-8">
                            ...
                            <div className="text-center font-semibold text-swGray700">
                              RANGE
                            </div>
                            <div className="text-center text-swGray500">
